...
internal static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        // ClangSharp may exit non-zero when emitting visibility warnings; output can still be valid.
        ...
        StripNativeTypeNameAttributes(nativeOut);
        Console.WriteLine($"Generated P/Invoke -> {nativeOut}");

        if (process.ExitCode is not 0 and not 122 and not 133 and not 134 and not 194)
        {
    ...
    private static void StripNativeTypeNameAttributes(string nativeOut)
    {
