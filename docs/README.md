...
| [**programming-guide/**](programming-guide/index.md) | Game devs | Multi-part tutorial (tilemaps, TMX import, gameplay grid, pathfinding, **2D platformer components**), [**UI toolkits**](programming-guide/1-overview-architecture/08-ui-and-toolkits.md), [**component reference**](programming-guide/1-overview-architecture/07-game-component-reference.md) (97 types) |
