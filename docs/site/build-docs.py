...
PAGES: list[tuple[Path, str, str]] = [
    ...
    (DOCS_ROOT / "VFX_ROADMAP.md", "vfx-roadmap.html", "VFX & Particles Roadmap"),
    ...
    (DOCS_ROOT / "WATER_ROADMAP.md", "water-roadmap.html", "Water Roadmap"),
    (DOCS_ROOT / "FOLIAGE_ROADMAP.md", "foliage-roadmap.html", "Foliage Roadmap"),
    (DOCS_ROOT / "ANIMATION_SAMPLE_ASSETS.md", "animation-sample-assets.html", "3D Animation Sample Assets"),
    (DOCS_ROOT / "BLENDER_GLTF_ANIMATION_EXPORT.md", "blender-gltf-animation-export.html", "Blender glTF Animation Export"),
...
MD_LINK_MAP.update(
    {
        ...
        "VFX_ROADMAP.md": "vfx-roadmap.html",
        "GUI_EDITOR_ROADMAP.md": "gui-editor-roadmap.html",
        "ANIMATION_3D_ROADMAP.md": "animation-3d-roadmap.html",
        "WATER_ROADMAP.md": "water-roadmap.html",
        "FOLIAGE_ROADMAP.md": "foliage-roadmap.html",
        "ANIMATION_SAMPLE_ASSETS.md": "animation-sample-assets.html",
        "BLENDER_GLTF_ANIMATION_EXPORT.md": "blender-gltf-animation-export.html",
