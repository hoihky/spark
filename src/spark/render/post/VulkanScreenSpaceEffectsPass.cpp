...
void VulkanScreenSpaceEffectsPass::RecordDepthCopy(
    ...
    VulkanSceneDepthCopyDst dst{.image = flight.depthSampleImage, .layout = &flight.depthSampleLayout};
    VulkanRecordCopySceneDepthToSampled(commandBuffer, sceneDepth.image, dst, extent);
}
