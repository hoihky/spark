...
UiTheme UiTheme::ClassicMint() noexcept {
    UiTheme t{};
...
UiTheme UiTheme::TwilightSlate() noexcept {
    UiTheme t{};
...
UiTheme UiTheme::SceneEditorDark() noexcept {
    UiTheme t{};
...
UiTheme MakeHighContrastBase() noexcept {
    UiTheme t{};
    t.controlFillAlpha = 1.0F;
...
UiTheme UiTheme::HighContrastLight() noexcept {
    UiTheme t = MakeHighContrastBase();
...
UiTheme UiTheme::HighContrastDark() noexcept {
    UiTheme t = MakeHighContrastBase();
...
UiTheme UiTheme::HighContrastYellowOnBlack() noexcept {
    UiTheme t = MakeHighContrastBase();
