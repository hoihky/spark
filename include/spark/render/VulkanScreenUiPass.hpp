...
private:
    ...
    VkShaderModule textVertModule_ = VK_NULL_HANDLE;
    VkShaderModule textFragModule_ = VK_NULL_HANDLE;
    VkPipeline textPipelines_[kSceneBlendModeCount]{};
    ...
    Array<VkDescriptorSet> textDescriptorSets_;
    VkSampler fontSampler_ = VK_NULL_HANDLE;
    FontAtlasGpu activeFontAtlas_{};
    VkBuffer fontStagingBuffer_ = VK_NULL_HANDLE;
    VkDeviceMemory fontStagingMemory_ = VK_NULL_HANDLE;
    void* fontStagingMapped_ = nullptr;
    VkDeviceSize fontStagingCapacity_ = 0;
    FontAtlasGpu pendingFontAtlas_{};
    VkDeviceSize pendingFontLayerBytes_ = 0;
    bool fontUploadPending_ = false;
    bool fontUploadClearsAtlas_ = false;
    const Font* pendingUiFont_ = nullptr;
    const Font* pendingUiBoldFont_ = nullptr;
    std::uint64_t fontRetireAfterFrame_ = 0;
    Array<RetiredFontAtlas> retiredFontAtlases_{};
    const Font* uploadedUiFont_ = nullptr;
    const Font* uploadedUiBoldFont_ = nullptr;
    VkDevice device_ = VK_NULL_HANDLE;

    Array<UiMeshFlightBuffers> textFlightBuffers_;
    Array<UiMeshFlightBuffers> solidFlightBuffers_;
    Array<float> textScratchVertices_;
    Array<std::uint32_t> textScratchIndices_;

    VkShaderModule solidVertModule_ = VK_NULL_HANDLE;
    VkShaderModule solidFragModule_ = VK_NULL_HANDLE;
    VkPipeline solidPipelines_[kSceneBlendModeCount]{};
    VkPipelineLayout solidPipelineLayout_ = VK_NULL_HANDLE;
    Array<float> solidScratchVertices_;
    Array<std::uint32_t> solidScratchIndices_;
};
