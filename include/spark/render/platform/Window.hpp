...
public:
    ...
    using FramebufferResizeCallback = Function<void(int width, int height)>;
    ...
    using CursorPosCallback = Function<void(double x, double y)>;
    void SetCursorPosCallback(CursorPosCallback callback);

    using ScrollCallback = Function<void(double xoffset, double yoffset)>;
    void SetScrollCallback(ScrollCallback callback);

    using CharCallback = Function<void(unsigned int codepoint)>;
